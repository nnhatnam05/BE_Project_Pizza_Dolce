...
public interface OrderRepository extends JpaRepository<OrderEntity,Long> {
    ...
    @Query("SELECT COALESCE(SUM(o.totalPrice), 0) FROM OrderEntity o WHERE o.orderType = 'DELIVERY' AND o.deliveryStatus = :deliveryStatus AND o.createdAt BETWEEN :startDate AND :endDate")
    BigDecimal getRevenueByDeliveryStatus(@Param("deliveryStatus") String deliveryStatus,
                                          @Param("startDate") LocalDateTime startDate,
                                          @Param("endDate") LocalDateTime endDate);

    @Query("SELECT COUNT(o) FROM OrderEntity o WHERE o.orderType = 'DELIVERY' AND o.deliveryStatus = :deliveryStatus AND o.createdAt BETWEEN :startDate AND :endDate")
    ...
    @Query("SELECT COALESCE(SUM(o.totalPrice), 0) FROM OrderEntity o WHERE o.deliveryStatus = 'DELIVERED' AND o.createdAt BETWEEN :startDate AND :endDate")
    ...
    @Query("SELECT COUNT(o) FROM OrderEntity o WHERE o.deliveryStatus = 'DELIVERED' AND o.createdAt BETWEEN :startDate AND :endDate")
